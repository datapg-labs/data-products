...
1. Open [datapg-labs/data-products](https://github.com/datapg-labs/data-products) and click
...
for everyone: a mistake in the docs, a reference project that no longer matches the
data, a clearer worked example. They are not the place for your own projects.

1. Fork `datapg-labs/data-products` and create a branch in your fork
...
platform, so use CI for checks that don't need it — `dbt parse`, SQL linting.
